...
// SetLevel 是 xorm 接口实现，我们默认不设置使失效，用系统统一设置 level
	...
	configJSON := fmt.Sprintf(`{
	 ...
	 "encoderConfig": {
	   ...
	   "levelEncoder": "lowercase"
		...
		Config.Log.Level,            // debug, info, warn, error dpanic panic fatal
		Config.Log.Mode,             // development mode: true, false
		Config.Log.Encoding,         // encoder: json
		Config.Log.OutputPaths,      // normal out file
		Config.Log.ErrorOutputPaths, // error out file
		Config.Log.InitialFields,    // initial field name
	)
